...
export default class TokenHelper {
    ...
    static setVirtualPath(token: string) {
        return LocalStorage.setItem<string>(Constants.VIRTUAL_PATH, token, Constants.TOKEN_EXPIRE_TIME);
    }

    static getVirtualPath(): string {
        return LocalStorage.getItem<string>(Constants.VIRTUAL_PATH) || "";
    }

    static removeVirtualPath(): boolean {
        return LocalStorage.removeItem(Constants.VIRTUAL_PATH);
    }
}
